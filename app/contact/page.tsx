        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >{t('title')}</h1>
              <p className="text-lg text-[#6B7280] max-w-xl mx-auto">{t('subtitle')}</p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-2 space-y-6">
                {contactInfo.map((item, i) => (
                  <motion.div
                    key={i}
                    className="flex items-start gap-4 p-5 rounded-xl border border-black/[0.06] bg-[#F3F2EF]/50"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: i * 0.1 }}
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#2563EB]/5 flex items-center justify-center flex-shrink-0">
              ...
              >
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#F3F2EF] border border-black/[0.08] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB] transition-all text-sm"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#374151] mb-1.5">{t('subject')}</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-sm font-medium text-[#374151] mb-1.5">{t('message')}</label>
                  <textarea
                    required
                    rows={5}
                    value={formData.message}
                    onChange={e => setFormData({ ...formData, message: e.target.value })}
                    className="w-full px-4 py-3 bg-[#F3F2EF] border border-black/[0.08] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB] transition-all text-sm resize-none"
                  />
                </div>
                <button
                  type="submit"
