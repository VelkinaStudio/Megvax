    ...
    <main className="min-h-screen flex bg-[#FAFAF8]">
      ...
      >
        ...
        <div className="w-full max-w-[420px] mx-auto lg:mx-0">
          ...
          <button
            type="button"
            onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/auth/facebook`; }}
            disabled={isLoading}
            className="w-full py-3 px-4 bg-[#1877F2] text-white font-medium rounded-xl hover:bg-[#166FE5] transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-sm active:scale-[0.98]"
          >
